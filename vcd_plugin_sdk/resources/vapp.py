...
class VCloudVM(VCloudResource):
    ...
    def add_disk_to_vm(self, vm_name, disk_size, disk_controller=None):
        if disk_controller:
            return self.add_disk_to_vm(vm_name, disk_size, disk_controller)
        return self.add_disk_to_vm(vm_name, disk_size)
